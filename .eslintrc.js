module.exports = {
    ...
    rules: {
		...
		// Variables should only be accessed from the block they're in (local scope)
		"block-scoped-var": "error",
		// If blocks should always use braces when multi-line
		"curly": ["error", "multi"],
		// Default parameters in functions should always come last
		"default-param-last": "error",
		// Dot notation e.g. foo.bar rather than foo["bar"] should always be favoured
		"dot-notation": "error",
		...
		// in the case of accessing first index, this should be done using a function
		// call
		"no-magic-numbers": "error",
		// Even if you know operator precedence off by heart, it's still nice to write
		// it in a form that someone can easily decode without referring to op-pref docs
		"no-mixed-operators": "error",
		// Really no good reason to write this without explanation, do two assignments
		// and make it clear. If it's a number, it's trivial. If you're doing it with an
		// object you probably need a deep copy anyway
		"no-multi-assign": "error",
		// If you need multi-line strings, you're writing your constants too long
		"no-multi-str": "error",
		// I write lots of these and they're bad form really. Don't nest your ternaries
		"no-nested-ternary": "error",
		// literally the worst mutable behaviour - changing function params in block? Blegh
		"no-param-reassign": "error",
		// I don't like a lack of assignment clarity e.g. i++ is much more readable as i += 1 or i = i + 1
		"no-plusplus": "error",
		// The logic in this is sound. Essentially we should just return the promise we're waiting on
		...
		"require-await": "error",
		"require-yield": "error",
		// Bracket newlining should be consistent and occur for large arrays
		...
		// The dot at the start indicates the continuation of the previous line...
		// the absence of semi-colon at the end indicates the continuation from the previous line perspective
		"dot-location": ["error", "property"],
		"eol-last": ["error", "always"],
		// There's absolutely no good reason to put a space between a function name and it's invoking parameters. Period.
